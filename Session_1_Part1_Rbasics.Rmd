...
We won't go into detail on R Projects here, but it is a useful feature of RStudio that, in general, behaves the way you want it to.  Main advantages:

+ working directory automagically set to home folder of the project 
+ integration with Git and Github
+ easier to make workflows that others can reproduce
+ *notes:* 
  + you can try it out for the things we do in this workshop
  + keep everything for your project in the home folder / subfolders
  + just remember to start working on your project by clicking on the **.Rproj** file in your local home folder, or the projects dropdown in the upper right of the RStudio banner.
